...
export default function LinkedIn() {
    return (
        <a href="https://www.linkedin.com/in/jhonathan-cutisaca/"
            ...
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="absolute right-4 bottom-4 top-auto md:right-8 md:top-8 text-xl text-white dark:text-[#ffffffaa]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="text-4xl md:text-7xl lg:text-9xl text-white" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
...
//   return (
//     <a
//       href="https://www.linkedin.com/in/jhonathan-cutisaca/"
//       target="_blank"
//       rel="noopener noreferrer"
//       aria-label="Linkedin"
//       className="flex flex-col justify-center items-center bg-[#0A66C2] rounded-3xl relative overflow-hidden col-span-1 aspect-square shadow-sm cursor-pointer hover:scale-[103%] transition duration-300 ease-in-out"
...
//         stroke="currentColor"
//         fill="currentColor"
//         strokeWidth="0" // Cambiado de stroke-width a strokeWidth
//         viewBox="0 0 24 24"
